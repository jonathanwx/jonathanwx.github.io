...
NexT.utils = NexT.$u = {
  ...
  wrapImageWithFancyBox: function() {
    $(".content img")
      .not("[hidden]")
      .not("#QR img")
      .not(".group-picture img,.swiper-container img,.post-gallery img")
      .each(function() {
        var $image = $(this);
        ...
        if ($imageWrapLink.size() < 1) {
          ...
          $imageWrapLink = $image
            .wrap('<a href="' + imageLink + '" data-fancybox="content"></a>')
            .parent("a");
        }
      ...
      .each(function() {
        ...
        if ($imageWrapLink.size() < 1) {
          var imageLink = $image.attr("data-original")
            ...
            : this.getAttribute("src");
          $imageWrapLink = $image
            .wrap('<a href="' + imageLink + '" data-fancybox="swiper"></a>')
            .parent("a");
        }
      ...
      .each(function() {
        ...
        if ($imageWrapLink.size() < 1) {
          var imageLink = $image.attr("data-original")
            ...
            : this.getAttribute("src");
          $imageWrapLink = $image
            .wrap('<a href="' + imageLink + '" data-fancybox="qrcode"></a>')
            .parent("a");
        }
